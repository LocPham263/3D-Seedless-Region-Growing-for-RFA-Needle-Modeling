...
import os
# LITS
nn_unet_csv = 'C:/Users/TheThuan/Desktop/result_val_needle_500/val_tumor_of_vessel_decathon_nnunet.csv'
resunet_csv = 'C:/Users/TheThuan/Desktop/result_val_needle_500/RFA/val_EMC_tumor_in_vessel_nnunet.csv'
# save box plots
liver_figure = 'D:/SAN_PHAM_HOAN_THIEN/box_plot/tumor/'
...
labels2 = ['DSC Decathlon', 'DSC EMC_NII_RFA']
...
plt.show()
# fig.savefig(os.path.join(liver_figure, 'tumor_RFA.png'), dpi=600)