...
liver_folder = 'D:/SAN_PHAM_HOAN_THIEN/histogram/liver_xoa_kim/'
needle_folder = 'D:/SAN_PHAM_HOAN_THIEN/histogram/needle_image/'

# save histogram
liver_needle_histogram = 'D:/SAN_PHAM_HOAN_THIEN/histogram/histogram/liver_needle/'
liver_histogram = 'D:/SAN_PHAM_HOAN_THIEN/histogram/histogram/liver/'
needle_histogram = 'D:/SAN_PHAM_HOAN_THIEN/histogram/histogram/needle/'
combine_needle_histogram = 'D:/SAN_PHAM_HOAN_THIEN/histogram/histogram/combine_needle/'
giu_nguyen_combine_needle = 'D:/SAN_PHAM_HOAN_THIEN/histogram/histogram/giu_nguyen_combine_needle/'
...
for file in tqdm(os.listdir(liver_needle_folder)):
    print("file :", file)
    if file in accept_file:
        ...
        # ax3d.set_ylim([0, 1])
        plt.plot(bin_edges1[0:-1], histogram1, 'b')  # <- or here
        plt.plot(bin_edges2[0:-1], histogram2, 'r')
        plt.legend(["Liver and needle", "Liver"], loc="upper right")
        fig1.show()
        plt.show()
        fig1.savefig(os.path.join(combine_needle_histogram, file + '.png'), dpi=600)
        ...
        fig2.show()
        plt.show()
        fig2.savefig(os.path.join(liver_needle_histogram, file + '.png'), dpi=600)
        ...
        fig3.show()
        plt.show()
        fig3.savefig(os.path.join(liver_histogram, file + '.png'), dpi=600)
        ...
        fig4.show()
        plt.show()
        fig4.savefig(os.path.join(needle_histogram, file + '.png'), dpi=600)
        ...
        fig5.show()
        plt.show()
        fig5.savefig(os.path.join(giu_nguyen_combine_needle, file + '.png'), dpi=600)
    else:
        pass